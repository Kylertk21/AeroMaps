...
class ForumPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create forum_post" do
    assert_difference("ForumPost.count") do
      post forum_posts_url, params: { forum_post: { comments: @forum_post.comments, post_text: @forum_post.post_text, post_topic: @forum_post.post_topic } }
    end
  ...
  test "should update forum_post" do
    patch forum_post_url(@forum_post), params: { forum_post: { comments: @forum_post.comments, post_text: @forum_post.post_text, post_topic: @forum_post.post_topic } }
